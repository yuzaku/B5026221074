...
@section('konten')
	...
	<form action="/snack/store" method="post" class="form-horizontal">
		{{ csrf_field() }}
        <div class="form-group row">
            <label class="control-label col-sm-2 align-right">Merk Snack:</label>
            <div class="col-sm-10">
              <input type="text" class="form-control" name="merksnack" placeholder="Masukkan Merk Snack">
            </div>
          </div>
        <div class="form-group row">
            <label class="control-label col-sm-2 align-right" >Stock Snack:</label>
            <div class="col-sm-10">
              <input type="number" class="form-control" name="stocksnack" placeholder="Masukkan Stock Snack">
            </div>
          </div>
        <div class="form-group row">
